...
export const slide03 = {
  ...
  enter(context) {
    const captions = [
      ...
      '<span>03</span><p><strong>Les entités saisissent leur ressenti dans Perception+.</strong><br />Le ressenti des clients constitue la troisième dimension de QIS.</p>',
    ...
    cleanup = presentSteps(context, ['Voir le parcours Météo', 'Voir le parcours Perception+', 'Passer côté abonné', 'Consulter les communications'], ({ step }) => {
