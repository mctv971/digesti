...
export const slide05 = {
  id: 'slide-05',
  render: () => `
    ${header(6, 'Abonnements & notifications', 'Mes accès. <em>Mes notifications.</em>')}
